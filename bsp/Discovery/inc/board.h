...
#define DISPLAY_Char __DISPLAY_Char
#define DISPLAY_Text(_X,_Y,_T) BSP_LCD_DisplayStringAt(_X,_Y,_T, LEFT_MODE)
#define DISPLAY_SetFcolor BSP_LCD_SetTextColor
