...
// 16bit Arithmetic
		...
		case 0x09: addHL(REG_BC); INC_CYCLES(TWO_CYCLE); break;
		case 0x19: addHL(REG_DE); INC_CYCLES(TWO_CYCLE); break;
		case 0x29: addHL(REG_HL); INC_CYCLES(TWO_CYCLE); break;
		case 0x39: addHL(REG_SP); INC_CYCLES(TWO_CYCLE); break;
		...
		case 0x03: inc16(&REG_BC); INC_CYCLES(TWO_CYCLE); break;
		case 0x13: inc16(&REG_DE); INC_CYCLES(TWO_CYCLE); break;
		case 0x23: inc16(&REG_HL); INC_CYCLES(TWO_CYCLE); break;
		case 0x33: inc16(&REG_SP); INC_CYCLES(TWO_CYCLE); break;
			
		// DEC Rnn
		case 0x0B: dec16(&REG_BC); INC_CYCLES(TWO_CYCLE); break;
		case 0x1B: dec16(&REG_DE); INC_CYCLES(TWO_CYCLE); break;
		case 0x2B: dec16(&REG_HL); INC_CYCLES(TWO_CYCLE); break;
		case 0x3B: dec16(&REG_SP); INC_CYCLES(TWO_CYCLE); break;
...
// Miscellaneous
		...
		// DAA
		case 0x27: daa(); INC_CYCLES(ONE_CYCLE); break;
